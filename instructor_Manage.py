...
class course_Booking(object):
    def __init__(self, window):
        ...
        # FRAME
        self.Top = Frame(self.root, width=1100, height=30, bd=8, relief="raise")
        self.Top.pack(side=TOP)
        self.Left = Frame(self.root, width=300, height=400, bd=8, relief="raise")
        ...
        self.StudentManagement_btn =Button(self.Top, text="Student Management", width=30, height=1, font=('arial', 12), fg='white', background='green', bd=2, command=self.students_Manage). \
            grid(row=0, column=1, padx=4, pady=5)
        
        self.InstructorManagement_btn = Button(self.Top, text="Instructor Management", width=30, height=1, fg='white', font=('arial', 12), background='green', bd=2, activeforeground = "green", activebackground = "pink", command=self.instructor_manage, relief="groove"). \
            grid(row=0, column=2, padx=4, pady=5)
        self.LessonBooking_btn = Button(self.Top, text="Lesson Booking", width=30, height=1, font=('arial', 12), fg='white', background='green', bd=2, command=self.course_Booking). \
        ...
        self.txt_title = Label(self.Top,width=40,font=('arial', 10),text="Cource Management - DanceFeet System",borderwidth=0,relief="groove",fg='green')
        ...
        self.txt_id = Label(self.Forms, text="ID:", font=('arial', 16), bd=12)
        self.txt_id.grid(row=0, sticky="e")
        self.txt_firstname = Label(self.Forms, text="First Name:", font=('arial', 16), bd=12)
        self.txt_firstname.grid(row=1, sticky="e")
        self.txt_lastName = Label(self.Forms, text="Surname:", font=('arial', 16), bd=12)
        self.txt_lastName.grid(row=2, sticky="e")
        self.txt_email = Label(self.Forms, text="Email:", font=('arial', 16), bd=12)
        self.txt_email.grid(row=3, sticky="e")
        self.txt_gender = Label(self.Forms, text="Gender:", font=('arial', 16), bd=12)
        self.txt_gender.grid(row=4, sticky="e")
        self.txt_DOB = Label(self.Forms, text="Date Of Birth:", font=('arial', 16), bd=12)
        self.txt_DOB.grid(row=5, sticky="e")
        self.txt_TpNo = Label(self.Forms, text="TP:", font=('arial', 16), bd=12)
        self.txt_TpNo.grid(row=6, sticky="e")
        self.txt_address = Label(self.Forms, text="Address:", font=('arial', 16), bd=12)
        self.txt_address.grid(row=7, sticky="e")
        self.txt_Style = Label(self.Forms, text="Style:", font=('arial', 16), bd=12)
        self.txt_Style.grid(row=8, sticky="e")
        self.txt_hourRate = Label(self.Forms, text="M. Rate able to pay:", font=('arial', 16), bd=12)
        self.txt_hourRate.grid(row=9, sticky="e")
        self.txt_availablity = Label(self.Forms, text="Date Available:", font=('arial', 16), bd=12)
        self.txt_availablity.grid(row=10, sticky="e")
        self.txt_Instructor= Label(self.Forms, text="Instructor:", font=('arial', 16), bd=12)
        self.txt_Instructor.grid(row=11, sticky="e")
        ...
        self.styles.grid(row=5, column=1)
        self.styles.config(state=DISABLED)

        self.tp = Entry(self.Forms, textvariable=self.TP, width=30)
        self.tp.grid(row=6, column=1)
        ...
        self.hrate.grid(row=9, column=1)

        self.entry_availability = Entry(self.Forms, textvariable=self.AVAILABILITY, width=30)
        self.entry_availability.grid(row=10, column=1)

        self.instructor_combo = ttk.Combobox(self.Forms, textvariable=self.INSTRUCTOR, width=30)
        self.instructor_combo.grid(row=11, column=1)
    ...
    #Data base connecting funtion
    def Database(self):
        global conn, cursor
        self.conn = sqlite3.connect('dancefeet_database.db')
        self.cursor = self.conn.cursor()

    # New record creating funtion
    def Create(self):
    ...
    # instrutor management class loading funtion
    def instructor_manage(self):
    ...
    # Students management class loading funtion
    def students_Manage(self):
